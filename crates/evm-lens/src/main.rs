...
fn print_usage_hint() {
    ...
    eprintln!("  {} {}", "evm-lens".bright_green(), "60FF61ABCD00");
    eprintln!("  {} {}", "evm-lens".bright_green(), "0x60FF61ABCD00");
    eprintln!();
    eprintln!("{}", "The input should be valid hexadecimal EVM bytecode.".bright_black());
}
